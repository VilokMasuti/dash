...
export default function CreateArticlePage() {
  ...
  const { addArticle } = useAppContext()
      ...
      <div className="p-6">
        ...
        <Card className="max-w-4xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>Enter the details for your new article</CardDescription>
          </CardHeader>
          <CardContent>
            <form id="create-article-form" onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                />
                {formErrors.keyword && <p className="text-red-500 text-sm mt-1">{formErrors.keyword}</p>}
              </div>
